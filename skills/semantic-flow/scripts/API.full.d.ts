 ...
 */
export declare function recordStageInsight(options: RecordStageInsightOptions): void;
 ...
 * @command review
 */
export declare function reviewSemanticFlow(options?: ReviewSemanticFlowOptions): void;
