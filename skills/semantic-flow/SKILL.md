---
name: semantic-flow
description: Use when implementing, reviewing, revising, validating, preparing, archiving, inspecting, or updating a semantic-flow review. Supports explicit commands and natural-language requests such as "implement the current user story using semantic flow". Only use when requested by the user.
---
