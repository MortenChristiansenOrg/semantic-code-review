...
For bugs in the skill, CLI, or viewer, explain `/semantic-flow report <problem>`.
It diagnoses defects and prepares upstream bug reports; implementation review
comments use `feedback`. Reporting works without an active implementation,
source checkout, working CLI, or Node.js. Help explains reporting without starting
diagnosis, checking authentication, searching issues, or submitting anything.
